  ...
  appConfig: {
    ...
    menuItems: [
      ...
      },
      {
        ...
        routerPath: 'assets',
        viewDescription:
          'The asset view allows you to create, edit and delete the assets (datasets) in your connector. An asset represents any data that can be shared, for example static files, streaming data or API access. The dashboard only allows you to create assets with data types that your data plane(s) support.',
      },
      {
        ...
        routerPath: 'policies',
        viewDescription:
          'The policy definitions view allows you to create, edit and delete policies. Policies are a generic way of defining a set of duties, rights, or obligations. EDC and DSP express policies with ODRL.',
      },
      {
        ...
        viewDescription:
          'The contract definitions view allows you to create, edit and delete contract definitions. Contract definitions link assets and policies by declaring which policies apply to a set of assets. Contract definitions contain two types of policies: an access policy (who can see or discover the data contract offer) and a contract policy (the actual terms and conditions of data use once a contract has been agreed upon).',
        divider: true,
      },
      {
        text: 'Contracts',
        ...
        viewDescription:
          'The contract view allows you to browse all contract negotiations that have been finished with an agreement. You can switch between providing and consuming contracts of the selected connector. For consuming contracts a transfer process can be started to receive the asset.',
      },
      {
        ...
        viewDescription:
          'The transfer history view lets you browse and deprovision finished and ongoing transfer processes. You can switch between providing and consuming transfer processes of the selected connector.',
      },
    ],
  } as AppConfig,
};
